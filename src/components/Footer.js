    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Clickloom.io</h3>
            <p className="text-gray-300 text-sm">
              Making the web safer, one link at a time.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/analyze" className="text-gray-300 hover:text-white text-sm">
                  Website Analysis
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <p className="text-gray-300 text-sm text-center">
            © {new Date().getFullYear()} Clickloom.io — All rights reserved.
          </p>
        </div>
      </div>
    </footer>
